...
export default function LoginForm({ className, ...props }: React.ComponentProps<"div">) {
  ...
  const [ handleSignIn, { loading, error, data }] = useMutation(SIGNIN);

  const onSubmit = (data: ICreateUserInput) => {
    handleSignIn({ variables: data }).then((res) => {
      console.log('res', res)
    })
  }
  ...
  useEffect(() => {
    if (data) {
      Cookies.set('access_token', data.signin.accessToken)
      Cookies.set('refresh_token', data.signin.refreshToken)
    }
  }, [data])
