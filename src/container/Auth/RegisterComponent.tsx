...
const RegisterComponent: React.FC<RegisterComponentProps> = ({ className, onSubmit, errorMessage, loading }) => {
  ...
  return (
    ...
    //       type="email"
    //       data-cy="email"
    //       className={cn(emailData.error && "border-red-500")}
    //     />
    //     {emailData.error && <p className="text-red-500 text-sm">{emailData.error}</p>}
    //   </div>
    ...
    //         data-cy="password"
    //         className={cn(passwordData.error && "border-red-500")}
    ...
    //       </button>
    //     </div>
    //     {passwordData.error && <p className="text-red-500 text-sm">{passwordData.error}</p>}
    //   </div>

    //   <div className="flex items-center justify-between">
    //     <p className="text-sm">
    //       Do you already have an account?&nbsp;
    //       <Link href="/auth/signin" className="text-blue-500 hover:underline" data-cy="signin-link">
    //         Then log in here
    //       </Link>
    //     </p>
    //     <Button onClick={onSubmitLoginDetails} disabled={loading} data-cy="signin">
    //       Register
    //     </Button>
    //   </div>
    // </div>
